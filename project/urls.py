...
urlpatterns = [
    ...
    url(r'^race_delete/(?P<slug>.+)/$', 'app.views.race_delete_view', name='race_delete_view'),
    url(r'^race_update/(?P<slug>.+)/$', 'app.views.race_update_view', name='race_update_view'),
    url(r'^race_create/$', 'app.views.race_create_view', name='race_create_view'),
    url(r'^race_detail/(?P<slug>.+)/$', 'app.views.race_detail_view', name='race_detail_view'),
    ...
    url(r'^candidate_compare/(?P<slug>.+)/(?P<pk>\d+)/$', 'app.views.candidate_compare_view', name='candidate_compare_view'),
    url(r'^switch_candidates/$', 'app.views.switch_candidates', name='switch_candidates'),
